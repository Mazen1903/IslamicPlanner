...
| **M19** | Premium entitlement scaffolding | **ARCHITECTURE FROZEN — OPUS APPROVED — READY FOR IMPLEMENTATION** | — | Architecture frozen 2026-09-18. Opus review APPROVED 2026-09-18 — amendments applied. `EntitlementService` (fail-closed), `PlanningDayMutationCoordinator`, `usePlanningDayMutation`, MIDNIGHT/CUSTOM gating. Zero migrations. Zero runtime deps. No billing SDK. See `docs/M19_ARCHITECTURE.md`. |
